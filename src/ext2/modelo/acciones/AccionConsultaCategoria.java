...
/**
 * Encapsula la busqueda de artistas por la categoría o tipo de estos
 */
public class AccionConsultaCategoria implements Accion{
	...
	public boolean ejecutar(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			this.modelo=daoConsultas.listaArtistasCategoria2(tipo);
