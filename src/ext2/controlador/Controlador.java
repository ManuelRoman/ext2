...
/**
 * Implementación del servlet Controlador con Datasources
...
public class Controlador extends HttpServlet {
	 ...
	 * contemplarse como propiedad del servlet.
	 */
	...
	public void init(ServletConfig config) throws ServletException {
		...
		sc.setAttribute("upt2romangracia", getUPApp());
	...
	public void destroy() {
		...
		sc.removeAttribute("upt2romangracia");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (sc.getAttribute("appOperativa").equals("true")) {
			...
			accion.setSc(sc);
			// Se proporciona la unidad de persistencia asociada al servlet a la acción
			accion.setUP(this.unidadPersistencia);
			...
			gesError("WEB-INF/gesError.jsp", new BeanError(1, "Aplicación no operativa"), request, response);
		}
